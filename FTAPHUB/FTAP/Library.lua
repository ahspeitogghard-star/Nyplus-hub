...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "NyPlus hub"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://83834497969387"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://83834497969387"
...
function ElementFunction:AddPlayerParagraph(userId)
	...
	return PlayerParagraph
			...
			function ElementFunction:AddSlider(SliderConfig)
				...
				-- ALTERADO: cor padrão do slider de verde para cinza
				SliderConfig.Color = SliderConfig.Color or Color3.fromRGB(100, 100, 100)
			...
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				-- ALTERADO: cor do ScrollFrame do dropdown de (40,40,40) para cinza (55,55,55)
				local DropdownContainer = AddThemeObject(SetProps(SetChildren(MakeElement("ScrollFrame", Color3.fromRGB(55, 55, 55), 4), {
					DropdownList
				}), {
					Parent = ItemParent,
				...
				local function AddOptions(Options)
					for _, Option in pairs(Options) do
						-- ALTERADO: cor dos botões de opção do dropdown para cinza (45,45,45)
...
function ElementFunction:AddPlayerDropdown(Config)
    ...
    -- ALTERADO: cores do PlayerDropdown de roxo para cinza
    local ButtonColor   = Color3.fromRGB(45, 45, 45)
    ...
    local DropdownContainer = AddThemeObject(
        SetProps(
            SetChildren(
                MakeElement("ScrollFrame", Color3.fromRGB(55, 55, 55), 4),
                { DropdownList }
            ),
            {
                Parent           = ItemParent,
